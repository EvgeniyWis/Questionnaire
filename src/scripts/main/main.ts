...
function create_survey__end_continue(func: VoidFunction, create_survey_page: boolean): void {
    create_questions__save.addEventListener("click", async function (): Promise<void> {
        ...
        let questions: NodeListOf<HTMLElement> = document.querySelectorAll(".create_question_active");
...
function create_answer(create_question__add_answer: HTMLElement, create_question__header: HTMLElement, create_question__count: number | string): void {
